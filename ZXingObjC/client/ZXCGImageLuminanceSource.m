...
- (ZXLuminanceSource *)rotateCounterClockwise {
  ...
  ZXCGImageLuminanceSource *zXCGImageLuminanceSource =
    [[ZXCGImageLuminanceSource alloc] initWithCGImage:rotatedImage left:top top:sourceWidth - (left + _width) width:self.height height:_width];
  CGImageRelease(rotatedImage);
  return zXCGImageLuminanceSource;
}
